$(function() {
  $(function setClass() {
    $(".topic h2").each(function(i) {
      $(this).attr('class', 'title' + (i + 1));
    });
    $(".topic p:first-child").each(function(i) {
      $(this).attr('class', 'pv' + (i + 1));
    });
    $(".topic p").each(function(i) {
      $(this).attr('class', 'question' + (i + 1));
    });
    $(".topic h2").each(function(i) {
      $(this).attr('class', 'title' + (i + 1));
    });
